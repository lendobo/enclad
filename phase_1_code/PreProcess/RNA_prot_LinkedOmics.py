...
proteomic_file_path = "data/LinkedOmics/TMT_prot_tumor.csv"
rna_file_path = "data/LinkedOmics/RNASeq_tumor_normal.cct"
...
# Export RNA dataframe to TSV
rna_data.to_csv("data/LinkedOmics/RNASeq_tumor_normal.tsv", sep="\t")
...
with open(
    "data/LinkedOmics/rna_indeces.txt",
    "w",
) as f:
...
with open(
    "data/LinkedOmics/protein_indeces.txt",
    "w",
) as f2:
...
with open(
    "data/LinkedOmics/matching_indeces.txt",
    "w",
) as f3:
...
# write to .txt file
with open(
    "data/LinkedOmics/prot_uniq_indeces.txt",
    "w",
) as f4:
...
# write to .txt file
with open(
    "data/LinkedOmics/rna_uniq_indeces.txt",
    "w",
) as f5:
